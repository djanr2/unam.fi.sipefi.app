...
(function( $ ){
	...
	var methods = {
		...
		init : function( options )
		{
			...
			var fontsizes = {	"Peque&ntilde;a"	:"2",
								"Normal":"3",
								"Mediana":"4",
								"Grande"	:"5",
								"Enorme"	:"6" };
			...
			var menuItems = { 'fonteffects': true,
							 ...
							 'font_size': {	"select":true,
							  ...
							  'color'	: { "text":"A",
											"icon": "fa fa-font", 
											"tooltip": "Color de texto/resaltado",
											"commandname":null,
											"custom":function(button){
													...
													var bgPallette    = $('<ul />',{id:"bgcolor_ui"}).append($('<li />').css({"width":"145px","display":"Block","height":"25px"}).html('<div>Color de resaltado</div>'));
						     ...
						     'ol'		: { "text": "Lista de numeraci\u00F3n", 
											"icon": "fa fa-list-ol", 
											"tooltip": "Lista de numeraci\u00F3n", 
											"commandname":"insertorderedlist", 
											"custom":null },

						     'ul'		: { "text": "Lista de vi\u00F1etas", 
											"icon": "fa fa-list-ul", 
						...
						'insert_table'	: { "modal": true,
						   ...
						   'outdent'	: { "text": "Disminuir sangr\u00EDa", 
											"icon":"fa fa-outdent", 
							...
							'togglescreen':{ "text": "Pantalla completa",
							...
							'splchars'	: { "text": "Insertar caracter especial", 
											"icon": "fa fa-asterisk", 
			...
			var menuGroups = {'texteffects' : ['bold', 'italics', 'underline', 'strikeout', 'color'],
